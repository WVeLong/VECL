...
def main(cfg, args):
    ...
    model = builder.build_lightning_model(cfg, dm)
    ...
    trainer = Trainer.from_argparse_args(args=trainer_args, deterministic=True, callbacks=callbacks, logger=logger)
...
if __name__ == "__main__":
    ...
    cfg.experiment_name = f"{cfg.experiment_name}_{cfg.phase}"
